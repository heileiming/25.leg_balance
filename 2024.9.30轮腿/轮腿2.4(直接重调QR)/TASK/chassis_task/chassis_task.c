...
/****************离地检测*****************/			
		...
		leg_left.FN[3]=-leg_left.F0*arm_cos_f32(leg_left.theta)-leg_left.Tp*arm_sin_f32(leg_left.theta)/leg_left.L0+wheel_mg;   //支持力		
...
/****************离地检测*****************/		
		...
		leg_right.FN[3]=-leg_right.F0*arm_cos_f32(leg_right.theta)-leg_right.Tp*arm_sin_f32(leg_right.theta)/leg_right.L0+wheel_mg;   //支持力
