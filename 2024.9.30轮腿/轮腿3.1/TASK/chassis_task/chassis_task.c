...
//		}
	...
	/*****************left************************/	
		...
		leg_left.new_d_theta=-Angular_Handler.V_X*TheattoRad-leg_left.d_fai0;
		...
		leg_left.wheel_T=leg_left.LQR_K[0]*(leg_left.theta-0.0f)        //负为正向
										+leg_left.LQR_K[1]*(leg_left.new_d_theta*wheel_theta_K-0.0f)
				 ...
				 leg_left.Tp=-leg_left.LQR_K[6]*(leg_left.theta-0.0f)      //+
										 -leg_left.LQR_K[7]*(leg_left.new_d_theta*leg_theta_K-0.0f)        //-
...
//		}		
	...
	/*****************right************************/	
		...
		leg_right.new_d_theta=-Angular_Handler.V_X*TheattoRad-leg_right.d_fai0;
	/////******* 滑动平均滤波器********////	
			for(int i=0;i<silide_N-1;i++)
			{
...
//		leg_right.x_set=leg_right.x_set+leg_right.v_set*Chassis_task_Time;
		...
		leg_right.wheel_T=leg_right.LQR_K[0]*(leg_right.theta-0.0f)
										  +leg_right.LQR_K[1]*(leg_right.new_d_theta*wheel_theta_K-0.0f)
				...
				leg_right.Tp=-leg_right.LQR_K[6]*(leg_right.theta-0.0f)         			 //-
										 -leg_right.LQR_K[7]*(leg_right.new_d_theta*leg_theta_K-0.0f)           //-
