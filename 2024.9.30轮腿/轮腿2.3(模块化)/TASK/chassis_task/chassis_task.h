...
#define  pitch_offect    1.5f


#define wheel_theta_K    0.6f
#define wheel_v_x_K   	 0.2f

#define leg_theta_K    0.6f
#define leg_v_x_K     0.2f

#define M1505B_R       0.09f    //   轮子直径180mm        

#define all_Mg    80.0f     //整车重量  单位N    11.5*9.8
...
typedef struct
{
	...
	float leave_leg_flag;        //离地标志位
	float v_error;
	float jump_flag,jump_time;    //跳跃标志位
	float last_yaw,yaw_set;
	float silide_buff[100],silide_sum;
