...
void chassis_L_init()//1200 30000   300
{
	...
	leg_left.leg_pid.Kp=600;	  leg_left.leg_pid.Ki=0;    leg_left.leg_pid.Kd=15000;   leg_left.leg_pid.max_iout=0;    leg_left.leg_pid.max_out=100.0f;
	...
	leg_left.roll_pid.Kp=3;	  leg_left.roll_pid.Ki=0;    leg_left.roll_pid.Kd=-1;   leg_left.roll_pid.max_iout=0;    leg_left.roll_pid.max_out=10.0f;
...
void chassis_R_init()
{	
	leg_right.right_leg_pid.Kp=600;	  leg_right.right_leg_pid.Ki=0;    leg_right.right_leg_pid.Kd=15000;   leg_right.right_leg_pid.max_iout=0;    leg_right.right_leg_pid.max_out=100.0f;
...
//		
//  									 +AK*leg_left.LQR_K[9]*(Kalman0.xhat_data[0]-leg_left.v_set)                //- 
...
//		
//										 +AK*leg_right.LQR_K[9]*(Kalman2.xhat_data[0]+leg_left.v_set)                //-
