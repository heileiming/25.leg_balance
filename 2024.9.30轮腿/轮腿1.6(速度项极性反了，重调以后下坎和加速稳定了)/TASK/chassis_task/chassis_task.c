...
void chassis_L_init()//1200 30000   300
{
	...
	leg_left.turn_pid.Kp=0.7f; 	leg_left.turn_pid.Ki=0; 	leg_left.turn_pid.Kd=0.1f; 	leg_left.turn_pid.max_iout=0; 	leg_left.turn_pid.max_out=3;
...
void kalman_task()
{
		...
		leg_left.v_filter=(Kalman2.xhat_data[0]-Kalman0.xhat_data[0])*0.5f;
...
////										 -leg_left.LQR_K[2]*(leg_left.x_filter-leg_left.x_set)		
										 -1.5f*leg_left.LQR_K[3]*(leg_left.v_filter+leg_left.v_set)                  //-
				 ...
				 leg_left.Tp=-3.0f*leg_left.LQR_K[6]*(leg_left.theta-0.0f)      //+
										 -leg_left.LQR_K[7]*(leg_left.d_theta_filter*leg_theta_K-0.0f)        //-
//		
  									 +10.0f*leg_left.LQR_K[9]*(leg_left.v_filter+leg_left.v_set)                //+
										 -5.0f*leg_left.LQR_K[10]*(Angular_Handler.ROLL-MPU_offect)*TheattoRad          //-
...
//		leg_left.F0=0;
		...
		{
				leg_left.wheel_T=0;
				leg_left.Tp=-3.0f*leg_left.LQR_K[6]*(leg_left.theta-0.0f)-leg_left.LQR_K[7]*(leg_left.d_theta_filter*leg_theta_K-0.0f);				//-
...
////											-leg_right.LQR_K[2]*(leg_right.x_filter-leg_right.x_set)
										  +1.5f*leg_right.LQR_K[3]*(leg_left.v_filter-leg_left.v_set)                   //+   
				...
				leg_right.Tp=-2.0f*leg_right.LQR_K[6]*(leg_right.theta-0.0f)           //-
										 -leg_right.LQR_K[7]*(leg_right.d_theta_filter*leg_theta_K-0.0f)           //-
//		
										 -10.0f*leg_right.LQR_K[9]*(leg_left.v_filter-leg_left.v_set)                //+
										 -5.0f*leg_right.LQR_K[10]*(Angular_Handler.ROLL-MPU_offect)*TheattoRad               //+
...
//		leg_right.F0=0;		
		...
		{
				leg_right.wheel_T=0;
				leg_right.Tp=-3.0f*leg_right.LQR_K[6]*(leg_right.theta-0.0f)-leg_right.LQR_K[7]*(leg_right.d_theta_filter*leg_theta_K-0.0f);				//-	
		}		
