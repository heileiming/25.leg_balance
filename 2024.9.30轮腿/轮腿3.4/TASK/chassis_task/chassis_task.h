...
#define  MPU_offect    	0.0f   //-4.4f
#define  pitch_offect    0.5f
...
#define all_Mg    100.0f     //整车重量  单位N    
#define wheel_mg  1.54f                 //轮子重量 

#define Max_v_set  2.5f
...
typedef struct
{
	...
	float YD,YB,XD,XB,LBD,A0,B0,C0,XC,YC,L0,d_L0,new_d_L0,d2_L0,last_L0,last_d_L0,d_XB,d_YB,A1;
	float fai0,fai1,fai2,fai3,fai4,theta,d_theta,d2_theta,last_theta,last_d_theta,d_fai1,d_fai0,d_fai4;
	float j11,j12,j21,j22;//笛卡尔空间力到关节空间的力的雅可比矩阵系数
	float un_j11,un_j12,un_j21,un_j22;//反解的雅可比
