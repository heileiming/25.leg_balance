...
{
	leg_left.collect_leg_pid.Kp=1000.0f; leg_left.collect_leg_pid.Ki=0.0f; leg_left.collect_leg_pid.Kd=5000.0f; leg_left.collect_leg_pid.max_iout=0;    leg_left.collect_leg_pid.max_out=600.0f;
	leg_left.leg_pid.Kp=1500;	  leg_left.leg_pid.Ki=0;    leg_left.leg_pid.Kd=25000;   leg_left.leg_pid.max_iout=0;    leg_left.leg_pid.max_out=400.0f;
...
void chassis_R_init()
{	
	leg_right.collect_leg_pid.Kp=1500.0f; leg_right.collect_leg_pid.Ki=0.0f; leg_right.collect_leg_pid.Kd=5000.0f; leg_right.collect_leg_pid.max_iout=0;    leg_right.collect_leg_pid.max_out=600.0f;	
	leg_right.right_leg_pid.Kp=1500;	  leg_right.right_leg_pid.Ki=0;    leg_right.right_leg_pid.Kd=25000;   leg_right.right_leg_pid.max_iout=0;    leg_right.right_leg_pid.max_out=400.0f;
...
//										 -leg_left.LQR_K[8]*(leg_left.x_filter-0)
		...
		leg_left.L0_set=0.15f+(rc_ctrl.rc.ch[2]/660.0f)/10.0f*2.0f;//-0.20f*arm_sin_f32((Angular_Handler.Pitch-pitch_offect)*TheattoRad);	
		...
		{
			leg_left.F0=-PID_Calc(&leg_left.collect_leg_pid,leg_left.L0,0.1f);
...
//										 +leg_right.LQR_K[8]*(leg_right.x_filter-0)
		...
		leg_right.L0_set=0.15f+(rc_ctrl.rc.ch[2]/660.0f)/10.0f*2.0f;//+0.20f*arm_sin_f32((Angular_Handler.Pitch-pitch_offect)*TheattoRad);
		...
		{
			leg_right.F0=-PID_Calc(&leg_right.collect_leg_pid,leg_right.L0,0.1f);
